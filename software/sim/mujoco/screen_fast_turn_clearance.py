...
def candidate_tree(scene, spacing_mm, axis_x_mm=-25, foot_length_mm=94, inner_trim_mm=0, battery_dx_mm=0, side_wall_tray=False, toe_only=False, visuals=False):
    root = ET.fromstring(runtime_xml(scene, visuals=visuals))
...
def screen(scene, spacing_mm, angle_deg, samples, axis_x_mm=-25, foot_length_mm=94, inner_trim_mm=0, battery_dx_mm=0, side_wall_tray=False, toe_only=False):
    root = candidate_tree(scene, spacing_mm, axis_x_mm, foot_length_mm, inner_trim_mm, battery_dx_mm, side_wall_tray, toe_only)
