...
r={'criteria':criteria,'criteria_classification':{'clamp_min_current_A':'Retained 100uA engineering screen; not the TLV431AI table maximum'},'manufacturer_current_specification':{'TLV431AI_IK_min_max_A':80e-6,'TLV431AQ_IK_min_max_A':100e-6,'TLV431B_IK_min_max_A':100e-6,'conditions':'VKA=VREF; table default TA=25C unless otherwise specified; do not extrapolate to adjusted-voltage/full-temperature operation'},'candidate':'TLV431AI; not selected for assembly','source':'https://www.ti.com/lit/ds/symlink/tlv431.pdf','source_revision':'SLVS139Z June 2024 sections 5.3 and 5.6','rows':rows,'qualified':False,'limits':['Feedback resistors load the OVLO divider even before regulation. Trip values omit unknown pre-regulation cathode current and are not guaranteed trip bounds.','Reference range 1.215..1.265V is specified at 10mA; actual lower current accuracy remains unbounded here.','Iref 0..0.9uA is a comparison envelope, not a whole-state guarantee.','Only initial resistor tolerance is covered; temperature and aging need allocation.','No capacitance, stability or transient overshoot proof; do not integrate on this screen alone.']}
