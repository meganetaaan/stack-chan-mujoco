...
p.add_argument('--source-pullups',action='store_true',help='revB: place pullups before monitored traces; default reproduces revA')
...
for side in ['LEFT','RIGHT']:
    ...
    for ref in ['U12','U13','R10','R11','R12','R13','C12','C13']:
        ...
        if ref=='R10' and a.source_pullups:
...
if a.source_pullups: report={'interconnects':links,**report}
