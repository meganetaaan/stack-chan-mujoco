...
source=Path('schematics/power/servo_power_clear_pullup_candidate_v1/assembly.json');direct=Path('validation/direct_rail_loads_v2/report.json')
...
subtotal=sum(x['upper_A'] for x in rows);d=json.loads(direct.read_text())['rails']['LOGIC3V3']['conditional_resistor_subtotal_A']
