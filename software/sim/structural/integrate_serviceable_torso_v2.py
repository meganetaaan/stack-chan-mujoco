...
paths={'new_fixed_shell':'validation/tab5_carrier_hardware_v2/fixed_shell.step','new_carrier':'validation/tab5_insert_candidate_v1/carrier_installed_approximation.step','new_tray':'validation/lb020_retention_v5/tray.step','new_battery':'validation/lb020_tray_v1/battery.step',**{f'new_strap_{i}':f'validation/lb020_retention_v5/strap_{i}.step' for i in range(2)}}
for sign in [-1,1]:
 for z in [88,112]:
