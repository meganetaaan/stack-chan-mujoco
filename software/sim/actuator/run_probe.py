...
def main():
    ...
    sim,names=full_body(a.sign,voltage=a.voltage,delay_s=a.delay,backlash=a.backlash)
    rows=[]
    def observe(s):
    ...
    report={'failure':sim.failure,'duration_s':sim.d.time,'joint_names':names,
            ...
            'settings':{'sign':a.sign,'voltage':a.voltage,'delay_s':a.delay,'backlash_rad':a.backlash},
