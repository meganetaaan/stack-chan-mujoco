...
現在はTab5の顔と胴体・脚長・足形状を保ち、前進・後退・左右旋回・停止とその切替を検証しています。股関節ヨーを含む12軸のr8候補について、205秒・24区間の正式評価で固定20/20・ランダム化18/20の総合通過を確認しました。全40試行の状態記録からの再評価も一致しています。成果物全体の確認は継続中です。
