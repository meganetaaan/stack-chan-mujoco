...
def main():
    ...
    for side,y in [('left',22.),('right',-22.)]:
        ...
        case=box((20,34,26),(-25,y,75))
        name=side+'_yaw_motor_case';records[name]=record_shape(name,case,.018)
        visual(base,name,case);collision_box(base,name,(20,34,26),(-25,y,75))
    ...
    report={'scope':__doc__,'base_before':old_base,'base_after':new_base,'new_yaw_link_parts':new_parts,
            ...
            'not_verified':['manufacturer shaft/horn offset','fasteners and actual bearings','support strength and stiffness',
