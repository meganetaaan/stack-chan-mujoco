...
def main():
    ...
    planner=YawCommandReference(initial,legacy.pose,core.smooth,protocol,kin,a.shift_fraction,a.steady_inset_mm,a.period,a.forward_period,a.swing_profile,a.forward_stance_width_mm)
