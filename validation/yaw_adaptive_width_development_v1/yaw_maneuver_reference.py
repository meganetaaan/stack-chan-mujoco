...
class YawCommandReference(CommandReference):
    def __init__(self, initial, pose, smooth, protocol, kinematics, shift_fraction=.35, steady_inset_mm=25.5, step_period=.32, forward_period=None, swing_profile="quartic", forward_stance_width_mm=None):
