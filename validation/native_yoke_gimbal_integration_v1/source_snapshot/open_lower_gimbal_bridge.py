...
plan=dict(scope=__doc__,cut_x_mm=[-55.4,-53],cut_z_mm=[-18.8,-16.4],cut_y_relative_to_center_mm=[-15.45,15.45],
...
for side,sign in [('left',1),('right',-1)]:
 ...
 cut=cq.Workplane('XY').box(2.4002,30.9,2.4002).val().translate((-54.2,sign*1.95,-17.6))
