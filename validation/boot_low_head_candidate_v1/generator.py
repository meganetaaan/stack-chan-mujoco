...
for side,files in paths.items():
 ...
 for x in (-34,36):
  for y in (sign*6-20.5,sign*6+20.5):
   ...
   pocket=cq.Solid.makeCylinder(2.4,2.21,cq.Vector(x,y,-21.2))
