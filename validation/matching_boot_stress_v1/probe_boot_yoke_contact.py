...
lines+=['*NODE PRINT,NSET=ANCHORS,TOTALS=ONLY','RF','*NODE PRINT,NSET=BOOT','U','*NODE PRINT,NSET=YOKE','U',('*CONTACT PRINT,SLAVE=YOKE_CONTACT,MASTER=BOOT_CONTACT' if a.reverse_contact else '*CONTACT PRINT,SLAVE=BOOT_CONTACT,MASTER=YOKE_CONTACT'),'CF,CDIS,CSTR','*EL PRINT,ELSET=BOOT','S','*EL PRINT,ELSET=YOKE','S','*END STEP']
