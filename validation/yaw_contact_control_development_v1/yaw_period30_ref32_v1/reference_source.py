...
class YawCommandReference(CommandReference):
    def __init__(self, initial, pose, smooth, protocol, kinematics, shift_fraction=.35, steady_inset_mm=25.5, step_period=.32):
        ...
        self.steady_inset_m=steady_inset_mm/1000
    ...
    def begin(self,t):
        ...
        if self.mode in ('step','align'):
            self.period=self.step_period;self.end=t+self.period
            ...
            inset=.024+(self.steady_inset_m-.024)*np.clip((self.motion_steps-1)/2,0.,1.)
