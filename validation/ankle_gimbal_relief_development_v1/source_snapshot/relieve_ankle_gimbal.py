...
plan=dict(scope=__doc__,rear_bridge_forward_shift_mm=.8,upper_rear_corner_z_max_mm=16.4,lower_bridge_upward_shift_mm=1.2,
...
for side,sign in [('left',1),('right',-1)]:
 ...
 cutter=cq.Workplane('XY').box(20,60,2.4002).val().translate((-55,sign*1.95,-18.8))
 extension=cq.Workplane('XY').box(2.4,34.9,2.4).val().translate((-54.2,sign*1.95,-17.6))
 new=old.cut(cutter).fuse(extension)
 top_cut=cq.Workplane('XY').box(30,60,10).val().translate((-45,0,21.4))
