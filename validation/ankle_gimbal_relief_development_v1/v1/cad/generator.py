...
plan=dict(scope=__doc__,rear_bridge_forward_shift_mm=.8,upper_rear_corner_z_max_mm=17.5,
...
for side,sign in [('left',1),('right',-1)]:
 ...
 cutter=cq.Workplane('XY').box(.8,60,2.4002).val().translate((-55.8,sign*1.95,-18.8))
 extension=cq.Workplane('XY').box(.8,34.9,2.4).val().translate((-53.4,sign*1.95,-18.8))
 new=old.cut(cutter).fuse(extension)
 top_cut=cq.Workplane('XY').box(12,60,10).val().translate((-54,0,22.5))
