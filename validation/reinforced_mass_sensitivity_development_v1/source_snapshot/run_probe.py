...
def main():
    ...
    sim,names=full_body(a.sign,model_path=a.model,voltage=a.voltage,delay_s=a.delay,backlash=a.backlash)
    rows=[]
    def observe(s):
    ...
    report={'failure':sim.failure,'duration_s':sim.d.time,'joint_names':names,
            ...
            'settings':{'model':str(a.model) if a.model else 'frozen r9','sign':a.sign,'voltage':a.voltage,'delay_s':a.delay,'backlash_rad':a.backlash},
