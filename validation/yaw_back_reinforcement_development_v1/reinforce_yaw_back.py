...
for side,sign in [('left',1),('right',-1)]:
 ...
 shape=original.fuse(cq.Workplane('XY').box(8,36,41.1).val().translate((-57.5,sign*26,70.45)))
 for dy in [-9,9]:
  for dz in [-12,12]:
...
report=dict(scope=__doc__,rows=rows,back_thickness_mm=8,land_radius_mm=6,rib_thickness_mm=a.rib_thickness_mm,
