...
Parent: `policies/r6_steering_seed20260923`. Initial weights are transferred from that trained policy; fresh optimizer, 32,768 additional PPO steps on `assets/r6_mounted_battery`, seed 20260924. This is a new plant with tray/strap/fastener mass and collisions. The predeclared 40 trials are complete: fixed 20/20, randomized 18/20. All trajectories and audits are in `validation/r6_mounted_seed20260924`; the two randomized failures are retained.
